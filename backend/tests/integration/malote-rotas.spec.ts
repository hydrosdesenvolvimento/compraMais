...
describe('Rotas de malote SEI (UC010 — HTTP)', () => {
  ...
  it('POST /malotes sem papel CPL/Administrador → 403', async () => {
    const r = await app.inject({ method: 'POST', url: '/malotes', headers: semPapel, payload: { fornecedorId: 'f1', editalId: 'e1', pecas } });
