...
| RNF006 | Identidade visual e acessibilidade conforme o **contrato de UX** — metade escrita ([DESIGN.md](ux/DESIGN.md) / [EXPERIENCE.md](ux/EXPERIENCE.md)) + metade artefato (bundles em [`../Prototipo/`](../Prototipo/)), ambas normativas (AD-39): **Poppins**, âmbar #FFB300, raio 8px/999px, acessibilidade e-MAG/WCAG 2.1 AA (foco visível âmbar 3px, alto contraste, navegação por teclado). ⚠️ **Paleta em arbitragem (0.7):** brandbook oficial `#0061AE`/`#003A68` ([`../Brandbook/`](../Brandbook/)) × navy `#0A2A52`/`#0E3A6E`/`#14467F` (bundles + implementação) — **decisão da Prefeitura** |
